...
class ScummVMStableBuild(ScummVMBuild):
    ...
    DATA_FILES = [
        ...
        "dists/engine-data/ultima.dat",
        "dists/engine-data/wintermute.zip",
        "dists/engine-data/xeen.ccs", # Renamed to mm.dat in master
        "dists/networking/wwwroot.zip",
        "dists/pred.dic",
        "dists/engine-data/cryo.dat",
        "dists/engine-data/macgui.dat",
...
builds.append(ScummVMStableBuild("stable", "https://github.com/scummvm/scummvm", "branch-2-7", verbose_build=True, daily=(4, 1), description="ScummVM stable\nFuture 2.7.x"))
