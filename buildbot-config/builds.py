...
builds.append(ScummVMStableBuild("stable", "https://github.com/scummvm/scummvm", "branch-3-0", verbose_build=True, use_ccache=False, daily=(4, 1), description="ScummVM stable\nFuture 3.0.x"))
