...
ENV PREFIX=$GCCSDK_INSTALL_ENV/vfp
ENV \
	def_aclocal(`${PREFIX}') \
	def_pkg_config(`${PREFIX}') \
	CFLAGS="-mfpu=vfp -ffunction-sections -fdata-sections -mno-poke-function-name" \
	CXXFLAGS="-mfpu=vfp -ffunction-sections -fdata-sections -mno-poke-function-name" \
	LDFLAGS="-mfpu=vfp -Wl,--gc-sections"
...
ENV \
	def_aclocal(`${PREFIX}') \
	def_pkg_config(`${PREFIX}') \
	CFLAGS="-O2 -ffunction-sections -fdata-sections -mno-poke-function-name" \
	CXXFLAGS="-O2 -ffunction-sections -fdata-sections -mno-poke-function-name" \
